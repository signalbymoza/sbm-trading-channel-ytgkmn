...
// Web-specific payment screen (NO Stripe)
// This file is used exclusively by web platform
...
export default function PaymentScreen() {
  console.log('PaymentScreen.web.tsx: Loading web-specific version');
  console.log('PaymentScreen.web.tsx: Platform:', Platform.OS);
  ...
  const handleContactForPayment = () => {
    console.log('User tapped Contact Us to Pay button (web)');
    showModal(
      'info',
